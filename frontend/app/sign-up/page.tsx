...
export default function Home() {
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    try {
      ...
      // Set cookies manually in the frontend
      //   document.cookie = `access_token=${data.accessToken}; path=/; max-age=${3600 * 24}; SameSite=None; Secure`;
      //   document.cookie = `refresh_token=${data.refreshToken}; path=/; max-age=${3600 * 24 * 7}; SameSite=None; Secure`;
